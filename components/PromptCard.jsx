...
export const PromptCard = ({post, handleTagClick,handleEdit,handleDelete}) => {
    ...
    return (
        <div className="prompt_card">
            <div className="flex justify-between-items gap-5">
                <div className="flex-1 flex justify-start items-center gap-3 cursor pointer">
                    ...
                    <h3 className="font-satoshi font-semibold text-grey-900">
                        ...
                        <p className="font-inner text-sm text-grey-500">
                            {post.creator.email}
                        </p>
                    </div>
                </div>
            ...
            {session?.user.id === post.creator._id && pathName === '/profile' && (
                <div className="mt-5 flex-center gap-4 border-t border-grey pt-3">
